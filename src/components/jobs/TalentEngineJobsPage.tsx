...
function JobsCard({ job, saved, onToggleSaved, onShare, onApply }: {
  job: JobCard;
  saved: boolean;
  ...
  return (
    <article className="group bg-white border border-gray-200 border-b-4 border-b-blue-600 rounded-lg p-4 sm:p-6 hover:shadow-md hover:border-blue-600 hover:border-b-blue-600 min-h-[240px] flex flex-col justify-between transition-all">
...
export default function TalentEngineJobsPage() {
  ...
  const filteredJobs = useMemo(() => {
    ...
    return [...results].sort((a, b) => b.matchPercentage - a.matchPercentage);
  }, [filters, searchQuery, selectedLocations, sortBy]);
